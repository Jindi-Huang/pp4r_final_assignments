...
def data_analysis(input_path, output_files):
    ...
    ax2.legend()
    plt.tight_layout()
    fig.savefig(output_files[0], bbox_inches='tight')
    plt.close()
    ...
    plt.savefig(output_files[1], bbox_inches = "tight")
    plt.close()
    ...
    plt.tight_layout()
    fig.savefig(output_files[2], bbox_inches='tight')
    plt.close()
    ...
    plt.savefig(output_files[3], bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    fig.savefig(output_files[4], bbox_inches='tight')
    plt.close()
    ...
    # Save heatmap
    plt.savefig(output_files[5], bbox_inches='tight')
    plt.close()
    ...
    func = open(output_files[6],"w")
    func.write(html)
    func = open(output_files[6])
